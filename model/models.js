sap.ui.define([
	...
	"./Office"
], function(JSONModel, Device, ODataModel, ResourceModel, Office) {
	"use strict";

	var me = {
		/**
		 * @memberOf com.xft.app.epa.lend.model.models
		 */
		...
		createODataModel: function(oOptions) {
			...
			if (!oOptions.url) {
				jQuery.sap.log.error("Please provide a url when you want to create an ODataModel",
					"com/xft/app/epa/lend.model.models.createODataModel");
				return null;
			}
		...
		createOfficeModel: function(oData) {
			var oModel = new Office(oData);
			return oModel;
		}
	};
